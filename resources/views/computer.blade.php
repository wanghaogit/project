...
var LAG_HOME_Fos_banner5 = "Home-follow us-huafans weibo";
  ...
  <div id="cbg-main-nav-wrapper" style="z-index:10001"> 
    ...
    <div id="cbg-main-nav" class="cbg-centered">
      ...
      <div class="cbg-wrapper">
        ...
        <ul class="cbg-inline">
          ...
          <li class="login-not" id="headerLoginNot"><a class="log-link fl" href="javascript:void(0)"><span>登录</span></a> <span class="s-line">|</span> <a class="reg-link fl" href="javascript:void(0)"><span>注册</span></a></li>
          
        </ul>
 
        <!-- search -->
        <div id="cbg-main-nav-search">
          <div class="cbg-search-form">
            <input onkeypress="javascript:if(event.keyCode=='13'){titleSearch();return false;}" onfocus="$(this).val('')" id="all_search" type="text" name="keywords" maxlength="90" placeholder="p9" data-allow-empty="true">
            <input type="submit" value="搜索" id="head_search_submit">
          </div>
          <div class="cbg-icon cbg-icon-search">搜索</div>
        </div>
      </div>
    </div>
    <!-- /main nav -->
    ...
    <div id="cbg-submenu-wrapper">
      <div class="cbg-submenu cbg-centered cbg-dark cbg-4cols cbg-series1" id="cbg-submenu-1" data-vals="phone_banner">
          ...
          <li class="col col-1 col-product" data-p-val="phone-b1">
            ...
            <div class="cbg-content">
              <a href="http://consumer.huawei.com/cn/mobile-phones/features/mate8-cn.htm">
                <h4><em>Mate</em>系列</h4>
                <h5>HUAWEI Mate 8</h5>
                <div class="cbg-img" onclick="javascript:trackPageview('/mobile-phones/rmd1')"><img alt="Ascend Mate7 移动版" src="Picture/img_con_cn_rmd_mobile_m.png" /></div>
                <p>执念·是一种信仰</p>
              </a>
              <a href="http://consumer.huawei.com/cn/mobile-phones/features/mate8-cn.htm" class="cbg-btn">了解更多</a>
            </div>
          </li>
          <li class="col col-2 col-product" data-p-val="phone-b2">
            ...
            <div class="cbg-content">
              <a href="http://consumer.huawei.com/cn/mobile-phones/features/p9-cn.htm">
                <h4><em>P</em>系列</h4>
                <h5>HUAWEI P9</h5>
                <div onclick="javascript:trackPageview('/mobile-phones/rmd2')" class="cbg-img"><img alt="华为P8" src= "/phoneImg/huawei p9 plus.jpg" /></div>
                <p>瞬间，定格视界的角度</p>
              </a>
              <a href="http://consumer.huawei.com/cn/mobile-phones/features/p9-cn.htm" class="cbg-btn">了解更多</a>
            </div>
          </li>
          <li class="col col-3 col-product" data-p-val="phone-b3">
            ...
            <div class="cbg-content">
              <a href="http://consumer.huawei.com/cn/mobile-phones/g9-plus/">
                <h4><em>G</em>系列</h4>
                <h5>HUAWEI G9 Plus</h5>
                <div onclick="javascript:trackPageview('/mobile-phones/rmd3')" class="cbg-img"><img alt="华为G7" src="Picture/img_con_cn_rmd_mobile_g.png" /></div>
                <p>表里不凡</p>
              </a>
              <a href="http://consumer.huawei.com/cn/mobile-phones/g9-plus/" class="cbg-btn">了解更多</a>
            </div>
          </li>
          <li class="col col-4 col-product" data-p-val="phone-b4">
            ...
            <div class="cbg-content">
              <a href="http://consumer.huawei.com/cn/mobile-phones/features/milan-cn.htm">
                <h4><em>畅享</em>系列</h4>
                <h5>华为麦芒5</h5>
                <div onclick="javascript:trackPageview('/mobile-phones/rmd4')" class="cbg-img"><img alt="Y635" src="Picture/img_con_cn_rmd_mobile_y.png" /></div>
                <p>年轻，不畏什么</p>
              </a>
              <a href="http://consumer.huawei.com/cn/mobile-phones/features/milan-cn.htm" class="cbg-btn">了解更多</a>
            </div>
          </li>
          <li class="col col-5 col-sns">
            <div class="cbg-content" data-vals="follow_banner">
              <h4>关注我们</h4>
              <ul class="cbg-inline">
                <li><a data-p-val="fo-b1" href="http://t.sina.com.cn/huaweidevice" class="cbg-icon cbg-icon-1 cbg-icon-sinaweibo" target="_blank">新浪微博</a></li>
                <li><a data-p-val="fo-b2" class="cbg-icon cbg-icon-1 cbg-icon-qqweibo" target="_blank" href="javascript:;"><i class="ico-wx">微信</i>
                        <span class="qrcode"><b></b></span></a></li>
              </ul>
              <h4>关注花粉俱乐部</h4>
              <ul class="cbg-inline">
                <li><a data-p-val="fo-b3" href="http://club.huawei.com/" class="cbg-icon-a cbg-icon-2 cbg-icon-emui" target="_blank">EMUI</a></li>
                <li><img height="96" style="display: none;" width="96" class="ui-QR" alt="" src="Picture/img_con_cn_weixin.png" title=""><a data-p-val="fo-b4" class="cbg-icon cbg-icon-2 cbg-icon-wechat cbg-wechat-qrcode" href="javascript:void()">微信</a></li>
                <li><a data-p-val="fo-b5" href="http://weibo.com/huafans" class="cbg-icon cbg-icon-2 cbg-icon-sinaweibo" target="_blank">新浪微博</a></li>
              </ul>
            </div>
          </li>
        </ul>
        <div data-p-val="phone-b5" class="cbg-view-all"><a href="http://consumer.huawei.com/cn/mobile-phones/index.htm">查看全部智能手机</a></div>
      </div>
...
<div class="list-items" style="display:block;">
        <div class="list-item" data-class="" dDocName='P9-CN'  >
          <div class="list-item-images">
          	            	  		...
          	            	  		<a href="/cn/mobile-phones/features/p9-cn.htm"><img class="list-item-image" alt="" src="computerImg/{{ $goods->goodsImg }}"></a>
