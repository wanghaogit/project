<!DOCTYPE html>
<html><head><iframe style="display: none;" src="javascript:false"></iframe>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta http-equiv="Content-Language" content="zh-cn">
<meta http-equiv="X-UA-Compatible" content="IE=edge; charset=utf-8">
<script src="{{ asset('order/ha.js') }}" async="" id="ha"></script><script async="" src="{{ asset('order/analytics.js') }}"></script><script>
...
<link href="{{ asset('order/ec.css') }}" rel="stylesheet" type="text/css">
<link href="{{ asset('order/css_con_cn_ht_share_002.css') }}" rel="stylesheet" type="text/css">

<link href="{{ asset('order/main.css') }}" rel="stylesheet" type="text/css">
<link href="{{ asset('order/css_con_cn_ht_share.css') }}" rel="stylesheet" type="text/css">
<script src="{{ asset('order/jsapi.js') }}" namespace="ec"></script><!--[if lte IE 6]><script>ol.isIE6=true;</script><![endif]--><!--[if IE 7]><script>ol.isIE7=true;</script><![endif]--><!--[if IE 8]><script>ol.isIE8=true;</script><![endif]-->
<!--[if lt IE 9 ]>
<script type="text/javascript" src="http://www.huawei.com/Assets/CBG/js/respond.min.js"></script>
<![endif]-->
<script src="{{ asset('order/script_dev_en_jquery_min.js') }}"></script>
<script src="{{ asset('order/ec.js') }}"></script> 
<script src="{{ asset('order/ec_002.js') }}"></script> 
<!--[if lt IE 9]><script src="http://shopcn-res.huaweistatic.com/integration/js/common/html5shiv.js"></script> <![endif]-->
<script src="{{ asset('order/script_con_cn_ht_share.js') }}"></script>
<script src="{{ asset('order/pc-g-analytics.js') }}"></script>
...
</script><link rel="stylesheet" type="text/css" id="SL_Style" href="{{ asset('order/translator.css') }}"></head>
...
<script src="{{ asset('order/base.js') }}"></script>
<script>
...
<div class="layout order">
	...
	<div class="order-form-area">
     ...
     <!-- ************************【start 新的地址  edit by wangshaohua  】******************************************************************  -->		
    	...
    	<div class="order-address" id="order-address-mod">
			...
			<div class="order-address-list" id="order-address-list" style="display: none;">
				<ol>
				</ol>
			</div>
	...
	<!--  *******************************【end 新的地址 】************************************************************  -->
		...
		<!--     新的发票信息     【start】      --><!--modify by l00222000 增加支持电子发票 20150320-->
			...
			<div class="order-invoice-list" id="order-invoice-area">
				<ul class="clearfix">
					...
					<input id="selfAllSkuIds" value="975001680" type="hidden">
		...
		<form id="order-confirm-form" action="/order/createcart" autocomplete="off" method="post">
			...
			<input name="skuIds" value="975001680" type="hidden">
			...
			<input name="sbs" value="975001680" type="hidden">
			...
			<input name="_sf" value="a5c03f8a48da52d826f3a198decd50df" type="hidden">
		</form>
	</div>
	<div class="sc-area">
	<!--如果有自营商品，展示自营商品-->
						...
						<tbody>
							<tr>
								<td class="tr-pro">
									<ul class="pro-area-2">
										<li>
										  <a title="HUAWEI G9 青春版 全网通版 16GB ROM（白色）" target="_blank" href="http://shopcn.huawei.com/item/416217227.html#975001680" seed="item-name">HUAWEI G9 青春版 全网通版 16GB ROM（白色）</a>
										</li> 
									 </ul>
								 </td>
								<!-- 预付订金商品的价格为空 -->
								<td class="tr-price">¥1599.00</td>
					...
					<div class="order-cost-area">
						...
						<tbody>
							<tr>
								...
								<td class="tar">&nbsp;¥&nbsp;
								   <em id="order-cost-area" data-oldval=" 1599.00">1599.00</em>
								</td>
							</tr>
							<tr>
								<td class="tal">运费：</td>
						...
						<p class="order-cost-total">
						  <span class="p-subtotal-price"> 应付金额：<b class="total">¥</b><b class="total" id="order-price" data-oldval="1599.00">1599.00</b></span>
					    </p>
                    ...
                    <td class="box-cc">
                    	<div>
							...
							<form action="" id="order-address-add-form" name="order-address-add-form">
								...
								<input name="randomFlag" id="randomFlag" value="a2dfa86cdff9c904d141781863e2da3f" type="hidden">
