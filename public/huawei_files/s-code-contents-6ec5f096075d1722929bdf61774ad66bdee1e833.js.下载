...
function s_doPlugins(s) {
  ...
  /* site core personalization event */
    if(s.eVar61)s.events=s.apl(s.events,'event61',',',2);
...
/********************************************************************/
function scSendEvent(key,attribute) {
	var s=s_gi(s_account);
	s.linkTrackVars='eVar58,list3,prop51';
	s.list3=s.prop51=attribute;
	s.eVar58=key;
	s.tl(s,'o','scSendEvent');
}

function scSendPersonalizationFlag(flag,reason) {
	var s=s_gi(s_account);
	s.linkTrackVars='eVar56,eVar57';
	s.eVar56=flag;
	s.eVar57=reason;
	s.tl(s,'o','scSendPersonalizationFlag');
}
...
function scSendCookie(vidcookie) {
	var s=s_gi(s_account);
	s.linkTrackVars='eVar61';
	s.eVar61=vidcookie;
	s.tl(s,'o','VisitorID_Send');
}
...
function scEventView(fileurl,filename,event_type_name)
{s.linkTrackVars='events,eVar53,eVar54,eVar55,prop52,prop53,prop54';
 s.linkTrackEvents='event55';
 s.events='event55';
 s.eVar53=s.prop52=fileurl;
 s.eVar54=s.prop53=filename;
 s.eVar55=s.prop54=event_type_name;
 s.tl(s,'o','eventview');
}
