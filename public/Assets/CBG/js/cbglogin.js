...
function tencentLogin(redirect) {
    if (redirect) {
        location.href = 'https://uniportal.huawei.com/uniportal/oauth2/tencent?client=mobile';
    } else {
        window.open('https://uniportal.huawei.com/uniportal/oauth2/tencent', 'QQ', popupPageFeatures());
    }
}

function linkedinLogin(redirect) {
    if (redirect) {
        //location.href = "https://uniportal-beta.huawei.com/uniportal/oauth2/linkedin?client=mobile";
        location.href = "https://uniportal.huawei.com/uniportal/oauth2/linkedin?client=mobile";
    } else {
        //window.open('https://uniportal-beta.huawei.com/uniportal/oauth2/linkedin', 'Linkedin', popupPageFeatures());
